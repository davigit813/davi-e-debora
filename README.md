...
<head>
    ...
    <!-- Metas para tela cheia (modo app) -->
    ...
    <style>
        * {
        ...
        /* Remove scroll e deixa 100% da tela */
        html, body {
            width: 100%;
            height: 100%;
            overflow: hidden;
        ...
        /* Container principal com fundo mesclado preto/rosa e corações */
        .love-card {
            position: fixed;
            top: 0;
            left: 0;
        ...
        /* Camada de corações flutuantes (todos os lugares) */
        .hearts-bg {
            position: absolute;
            inset: 0;
            width: 100%;
        ...
        /* Corações em forma de texto (unicode) */
        .hearts-unicode {
            position: absolute;
            inset: 0;
            width: 100%;
        ...
        /* Quadrado escuro central com letras brancas */
        .center-box {
            position: relative;
            z-index: 10;
            background: #0d0d0d;
...
<body>
    <div class="love-card">
        <!-- camada pesada de corações (fundo mesclado preto/rosa) -->
        ...
        <div class="center-box">
            <h1>EU TE AMO</h1>
            <h1 style="font-size: 1.4rem; margin-top: -0.2rem; opacity: 0.9;">DESDE O DIA
            </h1>
            <!-- data destacada no meio -->
            <div class="highlight-date">26/06/2026</div>
            

            <!-- horas, minutos, segundos em destaque -->
